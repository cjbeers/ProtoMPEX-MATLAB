function SPECTRA=CROSS_INTENSITY_SIM_PAR(SPECTRA,OBS,PARA,UNIV,OPT)
...
if MULT_PK~=0
    ...
    DFSSS_OPT_PROBE=cell(1,NT_PK);
    DFSSS_OPT_BOTH=cell(1,NT_PK);
    ...
    for ii=1:NT_PK
        ...
        DFSSS_OPT_PROBE{ii}.GENERAL.MODE='PROBE'; 
        DFSSS_OPT_BOTH{ii}.GENERAL.MODE='BOTH'; 
    end

    %**************
    %Print progress
    %**************    
    if PRINT_LOG==1 && NT_PK>0
        PRINT_PROGRESS_PAR('Crossover Peaks')

        PARALLEL_PROGRESS(NT_PK);
    end
    ...
    parfor ii=1:NT_PK
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        if HIT_PK(ii)==0   %%% LOGIC TO IGNORE CROSSOVER PEAK %%%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
            ...
            %*****************************************
            %Multiple DFSS and crossover scale factors
            %*****************************************
...
if MULT_DIP~=0
    ...
    DFSSS_OPT_PROBE=cell(1,NT_DIP);
    DFSSS_OPT_BOTH=cell(1,NT_DIP);
    ...
    %Print progress
    %**************    
    if PRINT_LOG==1 && NT_DIP>0
        PRINT_PROGRESS_PAR('Crossover Dips')

        PARALLEL_PROGRESS(NT_DIP);
    end
    ...
    parfor ii=1:NT_DIP
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        if HIT_DIP(ii)==0  %%% LOGIC TO IGNORE CROSSOVER DIP %%%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
