...
% IDK.XE=XE;
% IDK.IE=IE;
% IDK.INEW(1)=IDK.IE(1)-IDK.I_C(10);
% IDK.INEW(2)=IDK.IE(2)-IDK.I_C(32);
% IDK.INEW(3)=IDK.IE(3)-IDK.I_C(39);
% IDK.INEW(4)=IDK.IE(4)-IDK.I_C(74);
% IDK.INEW(5)=IDK.IE(5)-IDK.I_C(94);
% IDK.INEW(6)=IDK.IE(6)-IDK.I_C(114);
% IDK.INEW(7)=IDK.IE(7)-IDK.I_C(136);
% IDK.INEW(8)=IDK.IE(8)-IDK.I_C(157);
