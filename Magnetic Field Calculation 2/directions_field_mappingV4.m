function [zvec, bt] = directions_field_mappingV4(B_Field)
...
%     
%    helicon_current = 210; %Coils 3,4 PS3
%    current_A = 6500; %Coils 9-13  PS2
%    current_B = 8400; %Coils 7-8 PS1
%    current_C = 540;  %Coil 2 TR1
%    current_D =3900;  %Coil 1,6 TR2


   helicon_current = B_Field(1); %Coils 3,4 PS3
   current_A = B_Field(2); %Coils 9-13  PS2
   current_B = B_Field(3); %Coils 7-8 PS1
   current_C = B_Field(4);  %Coil 2 TR1
   current_D =B_Field(5);  %Coil 1,6 TR2
...
%run bprofm_12_coils_geo.m
    ...
    plot(zvec,bt(1,:),'b',m1_x,m_y,'r',m2_x,m_y,'r',m3_x,m_y,'r',m4_x,m_y,'r',...
                          ...
                          m9_x,m_y,'r',m10_x,m_y,'r',m11_x,m_y,'r',m12_x,m_y,'r',m13_x-0.5,m_y,'r','linewidth',2);
    grid
    title('mod B on axis');
    h=ylabel('|B|  (T)');
    set(h,'fontsize',12,'fontweight','bold');
    ...
    text(m13_x(1)+.15*cl(1)-0.51,0.05*bma,'13','fontsize',13);
