...
drawnow;    %draws the image of the delta T shot - first figure (1)
...
axis([0,4.5,0,0.1])                    %MS - adjusted axis to plot more of the machine; zoomed in
%plots flux flines (second figure (2))
...
axis([0,4.5,0,0.15]) %expanding plotted axis; MS edit
