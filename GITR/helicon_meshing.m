...
radius = 0.06256;
model = createpde;
importGeometry(model,'assets/helicon_cylinder_40cm.stl');% Import STL file
figure(2)
...
% set(gca, 'YDir', 'normal')
 set(gca, 'XScale', 'log')
title({'Sputtering Yield for D on Al','As a Function of Energy and Angle'})
xlabel('E [eV]') % x-axis label
ylabel('Angle [deg.]') % y-axis label
ylabel(c,'Sputtering yield')
set(gca,'fontsize',16)
set(gcf,'color','w')
