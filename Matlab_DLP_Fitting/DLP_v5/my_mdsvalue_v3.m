function [x,t] = my_mdsvalue_v3(shot,address)
% MY_MDSVALUE_v3 performs the same function as the mdsvalue.m function
...
% This upgrade from my_mdsvalue_v2 is to allow the use of arrays in
% addition to cells when inputing the address information
...
if iscell(address)
    ...
    nAddress = 1; % Data must be an Array containing the address
end
