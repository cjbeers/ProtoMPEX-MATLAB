...
file = dir('\\mpexserver\ProtoMPEX_Data\McPherson\calibration\cal_2018_04_13\*.SPE');...
...
dirpath=char('\\mpexserver\ProtoMPEX_Data\McPherson\calibration\cal_2016_08_04\*.SPE');
...
for t = 1:37
    ...
    Data{t} = readSPE('\\mpexserver\ProtoMPEX_Data\McPherson\calibration\cal_2018_04_13\',file(t).name);
...
Raw_data_bg = readSPE('\\mpexserver\ProtoMPEX_Data\McPherson\calibration\cal_2016_08_04\ROIs\abs_calib_20um_1s_bg_1.SPE');...
