...
Raw_data = readSPE('Z:\McPherson\calibration\abscal_2016_06_21\abs_calib_20um_500ms_4.SPE');...
    %USER Specifiy Location
length = size(Raw_data);
Raw_data_bg = readSPE('Z:\McPherson\calibration\abscal_2016_06_21\Background\abs_calib_20um_100ms_bg_9.5S_C.SPE');...
...
%Troubleshooting for spectrum
%max(cor_f1), max(cor_f2), max(cor_f3), max(cor_f4), max(cor_f5)
...
correctedtable(1,:)=flip(lambdaplot);
