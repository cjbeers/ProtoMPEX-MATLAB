...
if k==1
    ...
    Iabs(k+2,(a+j))= -4E-21*correctedtable(2,j)^6 + 1E-17*correctedtable(2,j)^5 - 2E-14*correctedtable(2,j)^4 + 2E-1*correctedtable(2,j)^3 - 6E-09*correctedtable(2,j)^2 + 9E-07*correctedtable(2,j)-5E-05;
    ...
    Iabs(k+2,(b+j))= -4E-21*correctedtable(2,j)^6 + 1E-17*correctedtable(2,j)^5 - 2E-14*correctedtable(2,j)^4 + 2E-1*correctedtable(2,j)^3 - 6E-09*correctedtable(2,j)^2 + 9E-07*correctedtable(2,j)-5E-05;
...
elseif k==3
    ...
    Iabs(k+2,(c+j))=  -4E-21*correctedtable(2,j)^6 + 1E-17*correctedtable(2,j)^5 - 2E-14*correctedtable(2,j)^4 + 2E-1*correctedtable(2,j)^3 - 6E-09*correctedtable(2,j)^2 + 9E-07*correctedtable(2,j)-5E-05;
...
elseif k==4
    ...
    Iabs(k+2,(d+j))= -4E-21*correctedtable(2,j)^6 + 1E-17*correctedtable(2,j)^5 - 2E-14*correctedtable(2,j)^4 + 2E-1*correctedtable(2,j)^3 - 6E-09*correctedtable(2,j)^2 + 9E-07*correctedtable(2,j)-5E-05;
...
elseif k==5
    ...
    Iabs(k+2,(e+j))= -4E-21*correctedtable(2,j)^6 + 1E-17*correctedtable(2,j)^5 - 2E-14*correctedtable(2,j)^4 + 2E-1*correctedtable(2,j)^3 - 6E-09*correctedtable(2,j)^2 + 9E-07*correctedtable(2,j)-5E-05;
