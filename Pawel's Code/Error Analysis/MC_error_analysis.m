...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for ii = 1:length(Ti)
    param = [Ti(ii),0,1.0,lambda0+0.05*(rand-0.5)];
    ...
    for jj = 1:length(S2N)
        ...
        for kk = 1:MC
            ...
            guess = [10*1e-1,lambda0,1,0];
            LB    = [0*1e-1,lambda0-0.1,1-1/4/S2N(jj),-1/4/S2N(jj)];
            UB    = [20*1e-1,lambda0+0.1,1+1/4/S2N(jj),-1/4/S2N(jj)];
