...
param = [Ti(100)*1e-1,lambda0,0];
Signal_Clean = Fit2Gauss_pixelated2(param,XX,IF);
plot(XX,Signal_Clean,'o--'); hold on;

param = [Ti(50)*1e-1,lambda0,0];
Signal_Clean = Fit2Gauss_pixelated2(param,XX,IF);
plot(XX,Signal_Clean,'o--');
