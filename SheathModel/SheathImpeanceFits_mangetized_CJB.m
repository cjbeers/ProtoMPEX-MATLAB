...
LayerData=xlsread('C:\Users\cxe\Documents\Proto-MPEX\COMSOLmodel\Helicon\Inputs\Beers_Inputs\HigherTe\Beers_Helicon_3D_HighDensityHighTe_SheathCenter_Mag2.xlsx');

%% Created variables from excel table
Inputs.Density=EdgeData(8:end,7);
Inputs.B=EdgeData(8:end,8); %8 is B0, 23 is Bz, 24 is Br
...
omegaci=7.63e6.*Inputs.B.*6.28; %rad/s for D, Dolan2013 eq.5.33
