...
Delta_Data_zoom = Data(zoom_y-80:zoom_y+80,zoom_x-80:zoom_x+80,firstplasma+1) - Data(zoom_y-80:zoom_y+80,zoom_x-80:zoom_x+80,f0);
figure;
...
for i=1:zoomframes
    %grabs temperature and delta T from a zoomed in location on the
     ...
     Temperature(:,:,i)=arrayfun(@(Data_zoom) seq.ThermalImage.GetValueFromEmissivity(0.5,Data_zoom),Data_zoom(:,:,i));
...
ellipse=imellipse(gca,[81-r2 73-r1 diameter large_diameter]);
...
save(filename,'DeltaTemperature','Frame','delta_t','PowerDensity_max','shotnumber','zoomframes','TG_frame','hel_frame','finalframenumber','TC_radius','px_per_cm','emax','helicon_start','center_plate','TG_templist','hel_templist','TG_templist_step','hel_templist_step','DeltaTMatrix_step','meanlist_step','meanlist','area_TG','avg_area','x_c2','y_c2','diameter', 'plasmaframe','Temperature');
